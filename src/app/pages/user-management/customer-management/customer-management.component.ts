...
import { CustomerManageService } from 'src/app/services/customer.service';
...
export class CustomerAllDetailsComponent {
  users: any;
  role: any;
  ...
  private customerService = inject(CustomerManageService);
  ...
  getAllStaff(pageNumber?: number, pageSize?: number) {
    ...
    this.customerService.getAllURL(pageNumber, pageSize).subscribe((response) => {
